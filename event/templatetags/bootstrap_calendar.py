...
from event.utils import MinifyJs
...
def bootstrap_controls(css_classes):
    ...
    """
    return render_to_string(
        'event/partial/calendar_controls.html',
        {'css_classes': css_classes}
    )
...
def bootstrap_calendar_js(*args, **kwargs):
    ...
    return render_to_string(
        'event/partial/calendar_js.html',
        options
    )
...
def bootstrap_calendar_css(*args):
    ...
    """
    return render_to_string(
        'event/partial/calendar_css.html'
    )
...
def bootstrap_calendar_init(*args, **kwargs):
    ...
    return render_to_string('event/partial/calendar_init.html', options)
